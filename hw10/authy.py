...
CONSUMER_KEY = 'VZimFmiH5DeDy61Xm5a9Qg'
CONSUMER_SECRET = 'ibs76cQLUnrml1PlcLMAlelGcSw'
TOKEN = '9H4xBLU1EWUuqT0Cmg8aq-0vejjPQQEh'
TOKEN_SECRET = '9IzxmytTjWYNmG-6EoNOVujDI04'
...
def main():
    ...
    try:
        a = search(input_values.term, input_values.location)
